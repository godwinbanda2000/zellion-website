        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in">
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
              ...
              <span className="text-secondary font-semibold text-lg">Zellion</span>
            </div>
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-lg mx-auto lg:mx-0">
              Discover the perfect property with Zellion's smart real estate platform. 
              Search, explore, and connect with top properties in your area.
            </p>
